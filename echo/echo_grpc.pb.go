...
type EchoClient interface {
	...
	// 双向流
	DoubleStreamingEcho(ctx context.Context, opts ...grpc.CallOption) (Echo_DoubleStreamingEchoClient, error)
}
...
func (c *echoClient) ServerStreamingEcho(ctx context.Context, in *EchoRequest, opts ...grpc.CallOption) (Echo_ServerStreamingEchoClient, error) {
	stream, err := c.cc.NewStream(ctx, &Echo_ServiceDesc.Streams[0], "/grpc.echo.Echo/ServerStreamingEcho", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *echoClient) ClientStreamingEcho(ctx context.Context, opts ...grpc.CallOption) (Echo_ClientStreamingEchoClient, error) {
	stream, err := c.cc.NewStream(ctx, &Echo_ServiceDesc.Streams[1], "/grpc.echo.Echo/ClientStreamingEcho", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *echoClient) DoubleStreamingEcho(ctx context.Context, opts ...grpc.CallOption) (Echo_DoubleStreamingEchoClient, error) {
	stream, err := c.cc.NewStream(ctx, &Echo_ServiceDesc.Streams[2], "/grpc.echo.Echo/DoubleStreamingEcho", opts...)
	if err != nil {
		return nil, err
	}
	x := &echoDoubleStreamingEchoClient{stream}
	return x, nil
}

type Echo_DoubleStreamingEchoClient interface {
	Send(*EchoRequest) error
	Recv() (*EchoResponse, error)
	grpc.ClientStream
}

type echoDoubleStreamingEchoClient struct {
	grpc.ClientStream
}

func (x *echoDoubleStreamingEchoClient) Send(m *EchoRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *echoDoubleStreamingEchoClient) Recv() (*EchoResponse, error) {
	m := new(EchoResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
type EchoServer interface {
	...
	// 双向流
	DoubleStreamingEcho(Echo_DoubleStreamingEchoServer) error
...
func (UnimplementedEchoServer) DoubleStreamingEcho(Echo_DoubleStreamingEchoServer) error {
	return status.Errorf(codes.Unimplemented, "method DoubleStreamingEcho not implemented")
}
...
func _Echo_DoubleStreamingEcho_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(EchoServer).DoubleStreamingEcho(&echoDoubleStreamingEchoServer{stream})
}

type Echo_DoubleStreamingEchoServer interface {
	Send(*EchoResponse) error
	Recv() (*EchoRequest, error)
	grpc.ServerStream
}

type echoDoubleStreamingEchoServer struct {
	grpc.ServerStream
}

func (x *echoDoubleStreamingEchoServer) Send(m *EchoResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *echoDoubleStreamingEchoServer) Recv() (*EchoRequest, error) {
	m := new(EchoRequest)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
var Echo_ServiceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "DoubleStreamingEcho",
			Handler:       _Echo_DoubleStreamingEcho_Handler,
			ServerStreams: true,
			ClientStreams: true,
		},
	},
